...
class KlassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create klass" do
    assert_difference("Klass.count") do
      post klasses_url, params: { klass: { name: @klass.name, period: @klass.period, teacher_id: @klass.teacher_id } }
    end
  ...
  test "should update klass" do
    patch klass_url(@klass), params: { klass: { name: @klass.name, period: @klass.period, teacher_id: @klass.teacher_id } }
