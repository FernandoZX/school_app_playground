...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference("Teacher.count") do
      post teachers_url, params: { teacher: { age: @teacher.age, name: @teacher.name, subject: @teacher.subject } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { age: @teacher.age, name: @teacher.name, subject: @teacher.subject } }
